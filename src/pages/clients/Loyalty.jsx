            ...
            <SectionHelp
              ...
              faq={[
                { q: 'Как создать программу?', a: (
                  <div>Нажмите <b>«Добавить»</b> справа вверху. Укажите название, тип программы, размер скидки и порог суммы.</div>
                ) },
                { q: 'Какие типы программ есть?', a: (
                  <ul>
                    <li style={{marginBottom:'.4rem'}}><b>Накопительная</b> — скидка растет от суммы покупок.</li>
