            ...
            <SectionHelp
              ...
              faq={[
                { q: 'Что такое кассовая смена?', a: (
                  <p>Это рабочий период кассира: от открытия кассы до ее закрытия. Все продажи и оплаты внутри этого времени привязываются к смене.</p>
                ) },
                { q: 'С чего начать работу?', a: (
                  <ol style={{paddingLeft:'1.15rem',margin:0}}>
                    <li style={{marginBottom:'.5rem'}}>Откройте кассу в разделе <b>«Касса»</b> — смена создастся автоматически.</li>
                ...
                { q: 'Почему выручка меньше, чем продаж?', a: (
                  <p>Выручка считается только по <b>кассовым чекам смены</b>. Быстрые продажи и другие операции в нее не входят.</p>
                ) },
