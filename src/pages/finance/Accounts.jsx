            ...
            <SectionHelp
              ...
              faq={[
                { q: 'С чего начать работу?', a: (
                  <ul>
                    <li>Проверьте <b>общий баланс</b> в круге сверху — это все ваши деньги вместе.</li>
                    <li>Если на счетах уже были деньги до учёта — внесите их через <b>Действия ▾</b> → <b>Начальные остатки</b>.</li>
                    <li>Заводите новые счета (карты, кассы, банки) через <b>Действия ▾</b> → <b>Добавить счет</b>.</li>
                    <li>Дальше деньги двигаются сами — от операций продаж и расходов, а переводы делайте вручную.</li>
                  </ul>
                ) },
