  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%',minHeight:0}}>
      ...
      <div className="search-row" style={{display:"flex",alignItems:"center",marginBottom:".5rem",width:'100%',flexWrap:'wrap',gap:'.4rem'}}>
        <div className="stock-search" style={{display:"inline-flex",alignItems:"center",gap:".4rem",width:"auto",border:"1px solid "+(searchFocus?'#111':'#e2e2e6'),borderRadius:"100px",padding:"8px 16px",background:"#fff",boxShadow:searchFocus?'0 2px 8px rgba(0,0,0,.12)':'0 1px 3px rgba(0,0,0,.05)',transition:'border-color .15s, box-shadow .15s'}}
