    ...
    <>
      <div className="sk-bar">
        <div className="grow">
            ...
            <SectionHelp
              ...
              faq={[
                { q: 'Как добавить поставщика?', a: (
                  <div>Нажмите <b>«Добавить»</b> справа вверху. Укажите <b>название</b> — оно обязательно. Контакт, телефон и способ связи можно заполнить позже.</div>
                ) },
          ...
          <div className="sub" style={{maxWidth:'210px'}}>База контрагентов и история сотрудничества</div>
        </div>
        <div className="***">
