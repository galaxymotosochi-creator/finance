...
<div className="page-header">
        <div>
          <h1 style={ {fontSize:"1.2re",fontWeight:"600",margin:"0"} }>Акции</h1>
          <div className="sub">Текущие и планируемые акции</div>
        </div>
        <div className="page-actions">
          <button className="btn-green" onClick="openPromoModal()">+ Добавить</button>
        </div>
      </div>
      <div className="nav-sep" style={ {margin:".25rem 0",width:"100%"} }></div>
      <div className="promo-calendar-wrap">
        <div className="promo-cal-header">
          <button className="promo-cal-nav" onClick="switchPromoMonth(-1)">&lsaquo;</button>
          <div className="promo-cal-month">Май 2026</div>
          <button className="promo-cal-nav" onClick="switchPromoMonth(1)">&rsaquo;</button>
        </div>
      ...
      <div style={ {display:"flex",alignItems:"cente",justifyContent:"space-betwee",margin:".5rem 0 .25re"} }>
        <div style={ {fontSize:".7re",color:"var(--muted)",textTransform:"uppercase",fontWeight:"600"} }>Все акции</div>
      </div>
      <div></div>
