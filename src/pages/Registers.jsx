...
export default function Registers({ fullscreen }) {
  ...
  return (
    <div style={{background:'#f5f5f7',height:'100%',display:'flex',padding:'20px',fontFamily:'Inter,-apple-system,BlinkMacSystemFont,sans-serif'}}>
      <div style={{display:'grid',gridTemplateColumns:'280px minmax(300px,1fr)',flex:1,flexShrink:0,background:'#fff',borderRadius:'24px',overflow:'hidden',boxShadow:'0 8px 60px rgba(0,0,0,.06)'}}>
      {toast && (
