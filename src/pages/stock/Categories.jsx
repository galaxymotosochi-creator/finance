    ...
    <>
      <div className="page-header">
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <SectionHelp
              ...
              blocks={[
                ...
                { title: 'Кнопка «Добавить категорию»', items: [
        ...
        <div className="page-actions">
          <button className="btn btn-dark" onClick={openAdd} style={{padding:'.5rem .9rem',fontWeight:600,borderRadius:'10px'}}>Добавить категорию</button>
        </div>
      </div>
