...
self.addEventListener('fetch', (e) => {
  ...
  // ===== Статика: СЕТЬ → кэш =====
  // Свежий файл всегда берём с сервера (файлы имеют уникальные имена при сборке),
  // кэш остаётся запасным — для офлайн-режима.
  if (
  ...
  // ===== Страница (index.html): свежая из сети, кэш — только когда нет интернета =====
