  ...
  return (
    <>
      <div className="sk-bar">
            ...
            <SectionHelp
              ...
              faq={[
                ...
                { q: 'Как добавить категорию?', a: (
                  <div>Нажмите <b>«Добавить категорию»</b> справа вверху. Укажите название и выберите тип — <b>Товар</b> или <b>Услуга</b>. Готово: категория сразу появится в фильтрах каталога и остатков.</div>
                ) },
                { q: 'Важно про тип!', a: (
                  <div>При создании позиции в каталоге <b>тип категории должен совпадать с типом позиции</b> — иначе позиции не появится в фильтре. Товар кладём в категорию типа «Товар», услугу — в «Услуга».</div>
                ) },
                { q: 'Что делает кнопка «⋯» у категории?', a: (
                  <ul>
                    <li style={{marginBottom:'.4rem'}}><b>«Редактировать»</b> — изменить название или тип.</li>
                    <li><b>«Удалить»</b> — убрать категорию. Товары из неё <b>останутся в каталоге</b>, просто станут без категории.</li>
                  </ul>
                ) },
              ]}
            />
        ...
        <div className="***">
          <button type="button" className="sk-dd-btn" style={{animation:'skpulse 2s ease-in-out infinite'}} onClick={openAdd}>Добавить категорию</button>
        </div>
      </div>
      ...
      <div className="sk-tablewrap" style={{flex:'none',minHeight:'auto'}}>
        ...
        <div className="sk-card" style={{position:'relative',overflowX:'auto',WebkitOverflowScrolling:'touch'}} ref={tblRef} onScroll={onTblScroll}>
