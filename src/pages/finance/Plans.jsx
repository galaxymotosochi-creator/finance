    ...
    <div>
      <div className="page-header">
        ...
        <div className="page-actions">
          <button className="btn btn-dark" onClick={save} disabled={saving} style={{padding:'.5rem .9rem',fontWeight:600,borderRadius:'10px'}}>{saving ? 'Сохранение...' : 'Сохранить'}</button>
        </div>
      </div>
