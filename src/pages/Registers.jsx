    ...
    <div style={{background:'#f5f5f7',height:'100%',display:'flex',flexDirection:'column',padding:'12px 0 0',width:'100%',boxSizing:'border-box',fontFamily:'Inter,-apple-system,BlinkMacSystemFont,sans-serif',position:'relative'}}>
      ...
      <div style={{flex:'0 0 ' + (isWide ? '420px' : '340px'),display:'flex',flexDirection:'column',background:'#fff',borderRadius:'20px',boxShadow:'0 4px 24px rgba(0,0,0,.05)',overflow:'hidden'}}>
        ...
        <div style={{padding:'12px 16px 14px',borderTop:'1px solid #f0f0f0',display:'flex',flexDirection:'column',gap:'8px',flexShrink:0}}>
            ...
            {/* Плашка скидки на чек — как в прототипе */}
            {cart.length > 0 && (
              <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:'8px',background:'#f6f7f9',border:'1px solid #e8e8ec',borderRadius:'12px',padding:'6px 9px'}}>
                ...
                <div style={{display:'flex',gap:'4px',overflowX:'auto',paddingBottom:'1px'}}>
                  ...
                  {(() => {
                    ...
                    return (
                      <span style={{display:'inline-flex',alignItems:'center',gap:'3px',borderRadius:'100px',padding:'2px 4px 2px 9px',border:'1.5px solid ' + (onOwn ? '#e8b800' : '#e3e3e8'),background: onOwn ? 'linear-gradient(135deg,#ffdd2d,#fff9db)' : '#fff'}}>
