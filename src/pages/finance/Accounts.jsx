              ...
              faq={[
                { q: 'С чего начать работу? (по шагам)', a: (
                  <ol style={{paddingLeft:'1.15rem',margin:0}}>
                    ...
                    <li style={{marginBottom:'.5rem'}}>Выберите <b>«Добавить счет»</b> и заведите свои счета: кассу, карту, банковский счёт или сейф. Укажите название и тип.</li>
                    <li style={{marginBottom:'.5rem'}}>Снова <b>«Действия ▾»</b> → <b>«Начальные остатки»</b> — впишите, сколько денег уже лежит на каждом счёте <i>до</i> начала учёта. Если счёт пустой, оставьте 0.</li>
                ...
                { q: 'Что означает каждая кнопка на странице?', a: (
                  <ul>
                    ...
                    <li><b>Строка счёта</b> (клик) — история операций по этому счёту.</li>
                    <li><b>⋯ в таблице</b> — редактировать или удалить счёт.</li>
                    <li><b>?</b> — эта справка.</li>
                  </ul>
                ) },
                { q: 'Что делают пункты меню «Действия ▾»?', a: (
                  <ul>
                    <li><b>Добавить счет</b> — завести новый кошелёк, кассовый ящик, карту или банковский счёт.</li>
                    <li><b>Начальные остатки</b> — деньги, которые уже были у бизнеса до начала учёта. В прибыль не попадают.</li>
                    <li><b>Корректировка</b> — исправить остаток на счёте. Баланс не может уйти в минус.</li>
                    <li><b>Инкассация</b> — изъять наличные из кассового ящика и зачислить на другой счёт.</li>
                    <li><b>Перевод между счетами</b> — переместить деньги со счёта на счёт. Это не доход и не расход бизнеса.</li>
                  </ul>
                ) },
                { q: 'Что такое «Начальные остатки» и почему их нет в прибыли?', a: (
                  <p>Это стартовая точка — сколько денег уже было на счетах до начала учёта. В прибыль они не входят, иначе она была бы завышена. Изменить остаток потом можно через <b>Корректировку</b>.</p>
                ) },
                { q: 'Чем инкассация отличается от перевода?', a: (
                  <p><b>Инкассация</b> — это изъятие наличных именно из кассового ящика и зачисление на другой счёт. <b>Перевод</b> — перемещение денег между любыми вашими счетами. Оба движения не считаются доходом или расходом бизнеса.</p>
                ) },
              ]}
            />
          </div>
